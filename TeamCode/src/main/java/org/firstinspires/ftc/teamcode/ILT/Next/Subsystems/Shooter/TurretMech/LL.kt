...
class LimelightAim(
    ...
    override fun update() {
        ...
        val mt1angle = currentAngle.deg + tx.deg + ofsTurret
        val targetAngle = Turret.normalizeAngle(mt1angle.inRad)
...
class LimelightAimCustom(
    ...
    var angle = atan2(dy.get(), dx.get()).rad - robotHeading.get() + ofsTurret
...
class LimelightAimMT2(
    ...
    override fun update() {
        ...
        val mt2angle = (fieldAngle - robotHeadingRad).rad + ofsTurret
        val targetAngle = Turret.normalizeAngle(
            mt2angle.inRad
        )
